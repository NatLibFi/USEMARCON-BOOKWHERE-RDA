...
my $inputfile = ReadData ("taulut.xlsx") || die $!;
my $outputfile = "337b.tbl"; # An example
my $preamble = "337 b  -osakenttien käännökset suomeen (RDA)"; # An example
my $default_value = "COPY"; # COPY copies input value to output as is, if value is not found in Look Up Table

my $sheet = "5";
my $inputvalue_firstcell = "A1";
my $inputvalue_lastcell = "A30";
my $outputvalue_firstcell = "B1";
my $outputvalue_lastcell = "B30";
